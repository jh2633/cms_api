  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Job" do
        expect {
          post :create, params: {job: create_attributes, keywords: keywords, category_id: category_id}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested job" do
        job = Job.create! valid_attributes
        put :update, params: {id: job.to_param, job: new_attributes, keywords: keywords, category_id: category_id}, session: valid_session
        job.reload
      ...
      it "assigns the requested job as @job" do
        job = Job.create! valid_attributes
        put :update, params: {id: job.to_param, job: valid_attributes, keywords: keywords, category_id: category_id}, session: valid_session
        expect(assigns(:job)).to eq(job)
      end
